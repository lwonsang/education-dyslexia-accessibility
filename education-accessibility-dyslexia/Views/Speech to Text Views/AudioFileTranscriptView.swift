...
//  AudioFileTranscriptView shows both the audio player (functions from AudioPlayerModel) and the transcripts for said audio files, which is highlighted when spoken aloud. Also allows users to press on individual words to open the WordBankView.
